IF EXISTS(SELECT * FROM sys.procedures WHERE name = 'spReportLoanRiskPerMonthBLDK') BEGIN
	DROP PROCEDURE spReportLoanRiskPerMonthBLDK
END
GO

CREATE PROCEDURE spReportLoanRiskPerMonthBLDK
