IF EXISTS(SELECT * FROM sys.procedures WHERE name = 'spReportLoanRiskPerMonthFYJ') BEGIN
	DROP PROCEDURE spReportLoanRiskPerMonthFYJ
END
GO

CREATE PROCEDURE spReportLoanRiskPerMonthFYJ
