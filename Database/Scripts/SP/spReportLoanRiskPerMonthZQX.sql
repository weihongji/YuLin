IF EXISTS(SELECT * FROM sys.procedures WHERE name = 'spReportLoanRiskPerMonthZQX') BEGIN
	DROP PROCEDURE spReportLoanRiskPerMonthZQX
END
GO

CREATE PROCEDURE spReportLoanRiskPerMonthZQX
