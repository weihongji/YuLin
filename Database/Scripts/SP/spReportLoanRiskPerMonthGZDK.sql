IF EXISTS(SELECT * FROM sys.procedures WHERE name = 'spReportLoanRiskPerMonthGZDK') BEGIN
	DROP PROCEDURE spReportLoanRiskPerMonthGZDK
END
GO

CREATE PROCEDURE spReportLoanRiskPerMonthGZDK
